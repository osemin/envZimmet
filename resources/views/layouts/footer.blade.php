...
<div class="page-footer">
    <div class="page-footer-inner">
        2022 ©
        <a target="_blank" href="#">Envanter Yazılımı</a> &nbsp;|&nbsp;
    </div>
    <div class="scroll-to-top">
        <i class="icon-arrow-up"></i>
    </div>
</div>
<script src="{{asset('admin_css/assets/global/plugins/respond.min.js')}}"></script>
<script src="{{asset('admin_css/assets/global/plugins/excanvas.min.js')}}"></script>
<script src="{{asset('admin_css/assets/global/plugins/ie8.fix.min.js')}}"></script>
<![endif]-->
<!-- BEGIN CORE PLUGINS -->
...
<script src="{{asset('admin_css/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js')}}" type="text/javascript"></script>
